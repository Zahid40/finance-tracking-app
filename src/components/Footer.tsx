      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 space-y-4">
            <Logo />
            <p className="text-xs font-normal text-white/80 hover:text-white">
              {AppDescriptionLong}
            </p>
          </div>
          ...
          <div>
            <div className="mt-4 flex space-x-4">
              <a href={AppFacebook} className="text-gray-400 hover:text-white">
              ...
              <a href={AppTwitter} className="text-gray-400 hover:text-white">
              ...
              <a href={AppGithub} className="text-gray-400 hover:text-white">
        ...
        <div className="pt-4  text-center text-white">
          ...
          <span className="text-xs font-medium text-white/70 hover:text-white">
